...
<Container className={classes.root}>
      <Typography variant='h4'>Current Detection Sensitivity Level</Typography>
      <Typography variant='h1' className={classes.sensitivity}>
        <Box fontWeight={900}>{current}</Box>
      </Typography>

      <Typography variant='h5'>
        <Box fontWeight={300}>Set Detection Sensitivity level</Box>
      </Typography>
...
export default class DetectionSensitivity extends React.Component {
  render() {
    return <Sensitivity />;
  }
}