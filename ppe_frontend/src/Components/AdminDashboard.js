...
import Tooltip from '@material-ui/core/Tooltip';
import RectangleLogo from '../fwdresoluteailogosthefinalset/resolute-AI-logo-rectangle-final.png';

import Logo from "./Logos/ResoluteAI-In-black-bg-social-media.png";
import HomeIcon from '../NavBarIcons/HomeIcon';
import VisitorTrackingIcon from '../NavBarIcons/VisitorTrackingIcon';
import VisitorProfileIcon from '../NavBarIcons/VisitorProfileIcon';
import LogsIcon from '../NavBarIcons/LogsIcon';
import ManualCheckInCheckOutIcon from '../NavBarIcons/ManualCheckInCheckOut';
import AnalyticsIcon from '../NavBarIcons/AnalyticsIcon';
import EmployeeManagementIcon from '../NavBarIcons/EmployeeManagementIcon';
...
// const socket = socketIOClient("http://localhost:3000socket/", { secure: true, reconnect: true, rejectUnauthorized : false });
// const socket    = io("vmsdev.facegenie.co:5020", {secure: true, path: 'socket/socket.io'} )



// var socket = io.connect('http://localhost:3000:5020', {secure:true, rejectUnauthorized: false, path: '/socket/socket.io'});

// var socket = io.connect('http://localhost:3000:5020/socket/socket.io',  {secure: true});
...
export default function AdminDashboard(props) {
          ...
          >
            <div style={{ display: 'flex' }}>
              <img
                src={RectangleLogo}
                alt='Not available'
                style={{ height: '50px', width: '100%', marginTop: "3%" }} //change width to 805 to show < icon
              />
              {/* <div className={classes.toolbarIcon}>
                <IconButton onClick={handleDrawerClose}>
  ...
  // return (
  //   <div>
  //     <AlertNotification socket={socket} />
  //     <div className={classes.root}>
  //       <CssBaseline />
